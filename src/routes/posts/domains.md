...
Also, another popular way of doing usernameless + passwordless login today is via ✨ ***blockchain*** ✨ and ✨ ***Web 3.0*** ✨. A colleague of mine, wrote a nice [blog post](https://luc.computer/p/web3-auth) about it.
